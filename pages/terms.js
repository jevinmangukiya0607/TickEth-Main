...
export default function Terms() {
  return (
    <div className="p-12">
      Terms and Conditions for TickEth English Terms and Conditions Last
      updated: April 21, 2022 Please read these terms and conditions carefully
      before using Our Service. Interpretation and Definitions Interpretation
      ...
      of directors or other managing authority. Country refers to: Tamil Nadu,
      India Company (referred to as either "the Company", "We", "Us" or "Our" in
      this Agreement) refers to LLC, Chennai, India. Device means any device
      that can access the Service such as a computer, a cellphone or a digital
      tablet. Service refers to the Website. Terms and Conditions (also referred
      as "Terms") mean these Terms and Conditions that form the entire agreement
      between You and the Company regarding the use of the Service. This Terms
      and Conditions agreement has been created with the help of the Terms and
      Conditions Generator. Third-party Social Media Service means any services
      or content (including data, information, products or services) provided by
      a third-party that may be displayed, included or made available by the
      Service. Website refers to TickEth, accessible from https://ticketh.io You
      ...
      using the Service, as applicable. Acknowledgment These are the Terms and
      ...
      then You may not access the Service. You represent that you are over the
      age of 18. The Company does not permit those under 18 to use the Service.
      ...
      using Our Service. Links to Other Websites Our Service may contain links
      ...
      Service will cease immediately. Limitation of Liability Notwithstanding
      any damages that You might incur, the entire liability of the Company and
      any of its suppliers under any provision of this Terms and Your exclusive
      ...
      country in which you are resident in. United States Legal Compliance You
      ...
      of prohibited or restricted parties. Severability and Waiver Severability
      ...
      right or to require performance of an obligation under these Terms shall
      ...
      contact@ticketh.io By visiting this page on our website:
      https://ticketh.io/contact By phone number: +91 9940453399
    </div>
  );
}
