...
export default function Privacy() {
  return (
    <>
      <PageHead title="Privacy | TickEth" />
      <div className="p-12">
        <h1 className="font-semibold text-2xl">Privacy Policy</h1>
        Last updated: April 21, 2022 <br />
        <br />
        ...
        <h2 className="font-semibold text-xl">Interpretation</h2>
        ...
        <ul className="list-disc ml-8">
          ...
          <li>
            ...
            this Agreement) refers to LLC, Chennai, India.
          </li>
          <li>
          ...
          <li>
            Website refers to TickEth, accessible from{' '}
            <a href="https://ticketh.io/">https://ticketh.io/</a>
          </li>
          <li>
        ...
        Data, We cannot guarantee its absolute security. Detailed Information on
        the Processing of Your Personal Data The Service Providers We use may
        have access to Your Personal Data. These third-party vendors collect,
        store, use, process and transfer information about Your activity on Our
        Service in accordance with their Privacy Policies. Usage, Performance
        and Miscellaneous We may use third-party Service Providers to provide
        better improvement of our Service. Magic Link Their Privacy Policy can
        be viewed at https://magic.link/legal/privacy-policy Children's Privacy
        ...
        https://ticketh.io/contact By phone number: +91 994043399
      </div>
    </>
  );
}
